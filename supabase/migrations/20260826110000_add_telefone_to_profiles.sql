-- Migration: add_telefone_to_profiles_and_update_function
-- Adiciona a coluna telefone em public.profiles e atualiza a função update_user_info para persistir o telefone

-- 1. Adicionar coluna telefone na tabela profiles caso não exista
ALTER TABLE public.profiles
ADD COLUMN IF NOT EXISTS telefone TEXT;

-- 2. Atualizar a função update_user_info com suporte ao campo telefone (com fallback)
